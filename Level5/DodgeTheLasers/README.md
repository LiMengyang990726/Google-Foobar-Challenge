...
### Solution Idea
This is a pure math problem, and the summation sequence is called the [Beatty Sequence](https://en.wikipedia.org/wiki/Beatty_sequence). I referred to the explanation [here](https://math.stackexchange.com/questions/2052179/how-to-find-sum-i-1n-left-lfloor-i-sqrt2-right-rfloor-a001951-a-beatty-s). 